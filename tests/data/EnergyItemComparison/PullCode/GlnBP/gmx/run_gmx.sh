...
gmx_d grompp -f martini_md.mdp -c minimized.gro -p system.top -n system.ndx -o conf.tpr -r minimized.gro -maxwarn 1 -v
gmx_d mdrun -deffnm conf -rerun md.gro -nt 1 -v
